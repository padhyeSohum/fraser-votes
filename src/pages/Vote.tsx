...
const Vote = () => {
    ...
    const allPositionsSelected =
        positions.length > 0 &&
        [positions[userGrade]].every((position) =>
            Boolean(selectedCandidates[position.id])
        );
    ...
    const handleSubmitVote = async () => {
        ...
        try {
            const votes: Omit<VoteType, "id" | "timestamp">[] = Object.entries(
                selectedCandidates
                    ...
                    <div className="max-w-lg mx-auto text-center">
                        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-8 shadow-md">
                            ...
                            <p className="text-gray-600">
                                The voting session is currently closed. Please
                                check back later or contact Aleena, Cody or
                                Akshat if you believe this is an error.
                            </p>
                        </div>
                    </div>
                </main>
                    ...
                    <div className="max-w-lg mx-auto text-center">
                        <div className="bg-green-50 border border-green-200 rounded-lg p-8 shadow-md animate-fade-in">
                            ...
                            <p className="text-gray-600 mb-6">
                                Your vote has been recorded successfully. Thank
                                you for participating in this election.
                            </p>
                            <p className="text-gray-500 italic text-sm">
                                Returning to voting screen...
                            </p>
                        </div>
                    </div>
                </main>
            ...
            <main className="container mx-auto py-8 px-4 flex-grow">
                <div className="flex flex-col items-center justify-center mb-6">
                    <h1 className="text-3xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">
                        {settings?.title ||
                            "Student Activity Council Elections"}
                    </h1>
                        ...
                        <Card className="border-t-4 border-t-blue-500 shadow-lg animate-fade-in">
                            <CardHeader className="pb-2">
                                <CardTitle className="text-center">
                                    Unlock Polling Station
                                </CardTitle>
                                <CardDescription className="text-center">
                                    Please enter your SAC member pin to access
                                    the ballot
                                </CardDescription>
                            </CardHeader>
                    ...
                    <div className="max-w-4xl mx-auto animate-fade-in">
                        <Card className="mb-8 shadow-lg overflow-hidden border-t-4 border-t-blue-500">
                            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b">
                                ...
                                <p className="text-sm text-gray-600">
                                    Select one candidate to be your grade's
                                    representative
                                </p>
                            </div>
                            ...
                            <CardContent className="p-6">
                                <div className="space-y-8">
                                    {[positions[userGrade]].map((position) => (
                                        <div
                                            key={position.id}
                                            className="pb-6 last:pb-0 border-b last:border-b-0 border-gray-100"
                                        >
                        ...
                        <Card className="bg-white p-6 rounded-lg shadow-md mb-6 border-t-4 border-t-blue-500">
                            ...
                            <ol className="list-decimal pl-5 space-y-2 text-gray-700">
                                ...
                                <li>
                                    Click on a candidate's card to select them
                                </li>
                                <li>
